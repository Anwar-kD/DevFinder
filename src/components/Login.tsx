...
export const Login = () => {
    ...
    const handleLogin = async () =>{
        ...
        try {
            ...
            // If you specifically expect a Firebase error:
      ...
      <main className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 max-w-md mx-auto w-full">
          ...
          <p className="text-gray-600 mb-8">
            Log in to track your job applications and get AI-powered insights.
          </p>
        ...
        {/* Right Column - Illustration (identique à SignUp) */}
            ...
            <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 transform rotate-1 max-w-md">
              ...
              <div className="space-y-4">
                <div className="bg-indigo-50 p-4 rounded-lg">
                  <div className="text-sm font-medium text-indigo-800">Welcome back!</div>
                  <div className="mt-2 text-xs text-gray-500">
                    Track your ongoing applications and get new recommendations.
                  </div>
                </div>
                
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="text-sm font-medium text-gray-800">Your Stats</div>
                  <div className="mt-2 text-xs text-gray-500">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="mt-2 text-xs text-gray-700">
                    Senior Frontend Developer at TechCorp matches your profile
                  </div>
                </div>
              </div>
            </div>
